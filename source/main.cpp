...
Result (*userExceptionHandlerStub)();
...
void skyline_main() {
    ...
    A64HookFunction(reinterpret_cast<void*>(nn::os::SetUserExceptionHandler), reinterpret_cast<void*>(stub), (void**)&userExceptionHandlerStub);
